...
local speed = movementSpeed or 200 -- valor padrão se não for definido externamente
...
-- 🔁 Substituído: Agora é ativado com clique (Activated) ao invés de Equipped
tool.Activated:Connect(function()
	if moving then return end -- evita múltiplas ativações simultâneas
